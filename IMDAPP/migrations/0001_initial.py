# Generated by Django 4.1.2 on 2022-12-06 09:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Stock',
            fields=[
                ('unit', models.CharField(choices=[('mtr', 'mtr'), ('cm', 'cm'), ('mm', 'mm'), ('kg', 'kg'), ('gm', 'gm'), ('ltr', 'ltr'), ('sqmtr', 'sqmtr'), ('sqcm', 'sqcm'), ('cum', 'cum'), ('ream', 'ream'), ('doz', 'doz'), ('pkts', 'pkts'), ('pairs', 'pairs'), ('rolls', 'rolls'), ('inches', 'inches')], max_length=50)),
                ('id', models.AutoField(primary_key=True, serialize=False)),
