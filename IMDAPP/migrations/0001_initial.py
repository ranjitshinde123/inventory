    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kdno', models.CharField(max_length=30)),
                ('sors_sink', models.CharField(max_length=30)),
                ('ref1', models.CharField(max_length=30)),
                ('ref2', models.CharField(max_length=30)),
                ('ref3', models.CharField(max_length=30)),
                ('unit_cost', models.CharField(max_length=30)),
